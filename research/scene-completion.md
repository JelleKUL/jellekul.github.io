...
- There is a need for complete and dynamic environments:
	...
	- Simulation design
- Current works:
	- complete the scene as a whole, not the objects separate
	- complete only the objects
	- remove the objects entirely
- No works that create a dynamic scene from a partial scan
...
## Methodology
### Pre-processing
Partially scanned scene + Images
### 3D Object detection
...
## Experiments
Compare the full scene construction to this method. Highlight the occlusions.
compare to sam3D
